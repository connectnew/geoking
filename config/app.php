...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'GeoKing'),
	'GOOGLE_CLIENT_IDD' => env('GOOGLE_CLIENT_IDD'),
    'GOOGLE_SECRET_IDD' => env('GOOGLE_SECRET_IDD'),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'url' => env('APP_URL', 'https://geoking.biz/gk8user/index.php'),
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\LocationsMetricsServiceProvider::class,
